...
function encheres_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_encheres_objets'] = array(
		...
		'date' => "date",
		'champs_editables'  => array('id_auteur', 'titre', 'titre', 'texte', 'prix_minimum', 'prix_actuel', 'date_debut', 'palier_encherissement', 'date_fin', 'palier_encherissement'),
		'champs_versionnes' => array('id_encheres_objet_source', 'id_auteur', 'titre', 'titre', 'texte', 'prix_minimum', 'prix_actuel', 'date_debut', 'date_fin', 'palier_encherissement', 'date_fin', 'palier_encherissement'),
