...
function encheres_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_encheres_objets'] = array(
		...
		'field'=> array(
			...
			"prix_minimum"       => "float (38,2) NOT NULL",
			"prix_actuel"        => "float (38,2) NOT NULL",
			"date_debut"         => "datetime NOT NULL DEFAULT '0000-00-00 00:00:00'",
			"date_fin"           => "datetime NOT NULL DEFAULT '0000-00-00 00:00:00'",
			"palier_encherissement" => "float (38,2) NOT NULL",
			"date_fin"           => "datetime NOT NULL DEFAULT '0000-00-00 00:00:00'",
			"palier_encherissement" => "float (38,2) NOT NULL",
		...
		'date' => "date",
		'champs_editables'  => array('id_auteur', 'titre', 'prix_minimum', 'prix_actuel', 'date_debut', 'palier_encherissement', 'date_fin', 'palier_encherissement'),
		'champs_versionnes' => array('id_encheres_objet_source', 'id_auteur', 'titre', 'prix_minimum', 'prix_actuel', 'date_debut', 'date_fin', 'palier_encherissement', 'date_fin', 'palier_encherissement'),
		'rechercher_champs' => array("titre" => 10, "prix_minimum" => 8, "prix_actuel" => 4),
