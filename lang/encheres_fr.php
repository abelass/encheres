...
// A
'activation_desactivation_projet' => 'ACTIVATION/DÉSACTIVATION DU PROJET',
...
'changer_objet_projet' => 'Changer le projet des objets attachés',
'chiffreskido' => 'Score Kidonateur',
'choisir_categorie' => 'Choisissez la catégorie',
'choisir_categories' => 'Choisissez les catégories',
'choisir_groupe_pays' => 'Choisir le groupe de mot pays',
'choisir_lieu' => 'Choisissez le lieu',
'choisir_pays' => 'Votre pays',
'choisir_projet' => 'Choisissez le projet',
'choisir_projet_destination' => 'Sélectionner le nouveau projet',
'choisir_region' => 'Choisissez votre',
'choisir_regions' => 'Choisissez une région',
'choisir_rubrique' => 'Choisir la rubrique',
'choisir_type_auteur' => 'Choisissez votre type',
'choisir_ville' => 'Choisissez la ville',
'choix_devise' => 'Choix de la devise du site',
'choix_projets' => 'Projets',
...
'cloture_vente' => 'La vente termine dans',
'commentaire' => 'Commentaire specifique',
'commentaire_default' => 'Pour obtenir votre place, il vous suffira d\'imprimer un email spécial qui vous sera envoyé lorsque l\'association aura validé la réception de votre payement. Cet email imprimé sera donc un \"bon à valoir\", faisant office de place.
...
'montant_payer_objet' => 'Montant à payer',
'montant_trop_bas' => 'Le montant minimum est de @montant_min@ @devise@!',


// N
'neuf' => 'Neuf',
'nom_asso' => 'Association bénéficiaire',
...
'numero_compte_bancaire_assoc' => 'Numéro de compte de l\'association',
'numero_compte_bancaire_vendeur' => 'Numéro de compte du kidonateur',
...
'occasion' => 'Occasion',
'ong' => 'Association/ONG',
'ong_kido' => 'Association donatrice',
'option' => 'En option',
'oui' => 'Oui',
...
'payement_objet' => 'Payement de l\'objet',
'payement_ok' => 'Votre payement Paypal a été validé!',
'payement_transport' => 'Payement des frais de livraison',
'payements' => 'Payer votre objet et ses éventuels frais de livraison.',
...
'titre_page_configurer_encheres' => 'Configuration Enchères',
'txn_id' => 'Numéro de transaction Paypal ',
